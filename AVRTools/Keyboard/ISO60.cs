...
{
    public partial class QMK61_ISO
    {
        #region kecap
...
"13.75,4,1.25,4,13,KEY_RIGHT_CTRL,KEY_RIGHT_CTRL"
    ...
    public partial class QMK63_ISO
    {
        #region kecap
        string[] keycap = new string[63]{
"0,0,1,0,0,MACRO2,KEY_TILDE",
"1,0,1,0,1,KEY_1,KEY_F1",
"2,0,1,0,2,KEY_2,KEY_F2",
"3,0,1,0,3,KEY_3,KEY_F3",
...
"11,0,1,0,11,KEY_MINUS,KEY_F11",
"12,0,1,0,12,KEY_EQUAL,KEY_F12",
"13,0,2,0,13,KEY_BACKSPACE,KEY_BACKSPACE",
"0,1,1.5,1,0,KEY_TAB,KEY_TAB",
"1.5,1,1,1,1,KEY_Q,KEYPAD_1",
"2.5,1,1,1,2,KEY_W,KEYPAD_2",
"3.5,1,1,1,3,KEY_E,KEYPAD_3",
...
"12.75,2,2.25,2,13,KEY_ENTER,KEY_ENTER",
"0,3,2.25,3,0,KEY_SHIFT,KEY_SHIFT",
"2.25,3,1,3,2,KEY_Z,KEY_NUM_LOCK",
"3.25,3,1,3,3,KEY_X,KEY_SCROLL_LOCK",
"4.25,3,1,3,4,KEY_C,MACRO5",
"5.25,3,1,3,5,KEY_V,",
"6.25,3,1,3,6,KEY_B,",
"7.25,3,1,3,7,KEY_N,",
...
"9.25,3,1,3,9,KEY_COMMA,AUDIO_VOL_DOWN",
"10.25,3,1,3,10,KEY_PERIOD,AUDIO_VOL_UP",
"11.25,3,1.75,4,7,KEY_SLASH,AUDIO_MUTE",
"13,3,1,3,13,KEY_UP,KEY_UP",
"14,3,1,3,12,KEY_DELETE,KEY_DELETE",
"0,4,1.25,4,0,KEY_CTRL,KEY_CTRL",
"1.25,4,1.25,4,1,KEY_FN,KEY_FN",
"2.5,4,1.25,4,2,KEY_ALT,KEY_ALT",
"3.75,4,6.25,4,5,KEY_SPACE,KEY_SPACE",
"10,4,1,4,10,KEY_FN,KEY_FN",
"11,4,1,4,11,KEY_FN,KEY_FN",
"12,4,1,4,8,KEY_LEFT,KEY_LEFT",
"13,4,1,4,12,KEY_DOWN,KEY_DOWN",
"14,4,1,4,13,KEY_RIGHT,KEY_RIGHT"
            };
        #endregion
    }
    public partial class QMK64_ISO
    {
        #region kecap
        string[] keycap = new string[64]{
"0,0,1,0,0,MACRO2,KEY_TILDE",
"1,0,1,0,1,KEY_1,KEY_F1",
"2,0,1,0,2,KEY_2,KEY_F2",
"3,0,1,0,3,KEY_3,KEY_F3",
...
"1.25,4,1.25,4,1,KEY_FN,KEY_FN",
"2.5,4,1.25,4,2,KEY_ALT,KEY_ALT",
"3.75,4,6.25,4,7,KEY_SPACE,KEY_SPACE",
